...
\newpagestyle{main}{
	\headrule
	\sethead[\thepage\quad\qquad{}第\thechapter{}章\quad\chaptertitle][][]% even
	{}{}{\thesection\quad\sectiontitle\quad\qquad\thepage}% odd
	\setfoot[][][]% even
	{}{}{}% odd
}
...
\renewcommand{\labelenumi}{(\theenumi)\quad}
\renewcommand{\theenumii}{\theenumi-\arabic{enumii}}
\renewcommand{\labelenumii}{(\theenumii)\quad}
...
\newtcbtheorem[number within=chapter]{thm}{Theorem}%定理
{mytheo}{tm}
...
{mytheo,
	colframe=charcoal,colback=charcoal!2!white,colbacktitle=charcoal,borderline south={2pt}{-2pt}{charcoal},}{e}
\newcommand{\exref}[1]{{\bfseries\sffamily Example~\ref{e:#1}}}
...
\newtcolorbox{example}{myproof,title=Example,after upper=}
\newtcolorbox{rem}{myproof,title=Remark,after upper=}
